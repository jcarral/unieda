...
public class MazeSolver {
	...
	/**
	 * FUnción que comprueba si una casilla es valida, es decir, esta dentro de los limites y esta libre
	...
	/**
	 * Funcion auxiliar que genera la lista con todas las coordenadas que forman parte del recorrido. S
	 * Solución de forma recursiva
	 * @param lista lista donde se almacenan las coordenadas que forman parte del recorrido
	...
	static public class Coords{
		...
		/**
		 * Función que le da un valor al estado de la casilla en función de si es true=libre o false=bloqueada
		 */
